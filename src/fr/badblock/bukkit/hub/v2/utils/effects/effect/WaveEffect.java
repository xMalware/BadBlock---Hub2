...
public class WaveEffect extends Effect {
	...
	/**
	 * Do not mess with the following attributes. They build a cache to gain
	 * performance.
	 */
	...
	/**
	 * Velocity of the wave Call velocity.zero() if the wave should be
	 * stationary
	 */
	...
	/**
	 * Call this method when you change anything related to the creation of the
	 * wave
	 */
