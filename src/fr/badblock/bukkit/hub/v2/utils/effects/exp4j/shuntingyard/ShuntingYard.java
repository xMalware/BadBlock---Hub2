 ...
 */
package fr.badblock.bukkit.hub.v2.utils.effects.exp4j.shuntingyard;
...
import fr.badblock.bukkit.hub.v2.utils.effects.exp4j.tokenizer.Tokenizer;
...
public class ShuntingYard {
	 ...
	 * @param userFunctions
	 *            the custom functions used
	 * @param userOperators
	 *            the custom operators used
	 * @param variableNames
	 *            the variable names used in the expression
	 * @return a
	 *         {@link fr.badblock.bukkit.hub.v1.effectlib.exp4j.tokenizer.Token}
