...
package fr.badblock.bukkit.hub.v2.utils.effects.exp4j;
...
import fr.badblock.bukkit.hub.v2.utils.effects.exp4j.function.Functions;
import fr.badblock.bukkit.hub.v2.utils.effects.exp4j.operator.Operator;
import fr.badblock.bukkit.hub.v2.utils.effects.exp4j.shuntingyard.ShuntingYard;

/**
 * Factory class for {@link Expression} instances. This class is the main API
 * entrypoint. Users should create new {@link Expression} instances using this
 * factory class.
 */
public class ExpressionBuilder {
	...
	/**
	 * Create a new ExpressionBuilder instance and initialize it with a given
	 * expression string.
	 * 
	 * @param expression
	...
	public Expression build() {
		...
		return new Expression(
				ShuntingYard.convertToRPN(this.expression, this.userFunctions, this.userOperators, this.variableNames),
	...
	/**
	 * Add a {@link net.objecthunter.exp4j.function.Function} implementation
	 * available for use in the expression
	 * 
	 * @param function
	 *            the custom {@link net.objecthunter.exp4j.function.Function}
	 *            implementation that should be available for use in the
	 *            expression.
	...
	/**
	 * Add multiple {@link net.objecthunter.exp4j.function.Function}
	 ...
	 * 
	 * @param functions
	 *            A {@link java.util.List} of custom
	 *            {@link net.objecthunter.exp4j.function.Function}
	 *            implementations
	 * @return the ExpressionBuilder instance
	 */
	...
	/**
	 * Add multiple {@link net.objecthunter.exp4j.operator.Operator}
	 * implementations which should be available for use in the expression
	 * 
	 * @param operators
	 *            the {@link java.util.List} of custom
	 *            {@link net.objecthunter.exp4j.operator.Operator}
	...
	/**
	 * Add an {@link net.objecthunter.exp4j.operator.Operator} which should be
	 * available for use in the expression
	 * 
	 * @param operator
	 *            the custom {@link net.objecthunter.exp4j.operator.Operator} to
	 *            add
	 * @return the ExpressionBuilder instance
	 */
