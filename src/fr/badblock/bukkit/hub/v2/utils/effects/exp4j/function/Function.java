...
package fr.badblock.bukkit.hub.v2.utils.effects.exp4j.function;
...
public abstract class Function {
	 ...
	 * @deprecated since 0.4.5 All unicode letters are allowed to be used in
	 *             function names since 0.4.3. This API Function can be safely
	 *             ignored. Checks for function name validity can be done using
	 *             Character.isLetter() et al.
	 */
	@Deprecated
	...
	/**
	 * Method that does the actual calculation of the function value given the
	 * arguments
	 * 
	 * @param args
	 *            the set of arguments used for calculating the function
